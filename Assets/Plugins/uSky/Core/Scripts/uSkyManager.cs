...
//	private readonly Vector3 BetaM = new Vector3 (4e-3f,4e-3f,4e-3f);// cheaper
	...
	// 0 ~ 2.0 // Sun fall ratio function based on Eric Bruneton 
	public float uMuS { get { return Mathf.Atan (Mathf.Max (SunDir.y, -0.1975f) * 5.35f) / 1.1f + 0.74f;}}

	// 0 ~ 1.0
	public float DayTime { get { return Mathf.Min (1, uMuS); }}

	public float SunsetTime {
		get { return Mathf.Clamp01 ((uMuS - 1.0f) * (2.0f / Mathf.Pow (RayleighScattering, 4f))); }
	}
	...
	public Vector3 mieConst {
		get { return new Vector3 (1f, BetaR.x/ BetaR.y, BetaR.x/ BetaR.z) * 4e-3f * MieScattering;}
	}
...
//	public Vector3 skyMultiplier {
//		get{
//			return new Vector3 ( Mathf.Clamp01 ((uMuS - 1.0f) * (2.0f / Mathf.Pow (RayleighScattering, 4f))), 
//			                    Exposure * 4 * DayTime * Mathf.Sqrt(RayleighScattering), NightTime) ;
//		}
//	}
