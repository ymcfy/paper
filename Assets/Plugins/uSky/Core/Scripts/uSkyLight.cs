...
//				if (RenderSettings.ambientMode == AmbientMode.Flat)
		...
		public Color CurrentGroundColor {
			get{ return colorOffset (Ambient.GroundColor.Evaluate (currentTime), 0.25f, 0.85f, true); }
		}
		...
		private Color colorOffset ( Color currentColor, float offsetRange, float rayleighOffsetRange, bool IsGround ){
			...
			if (IsGround)
				t = new Vector3 (groundColorTint.r / 0.369f * 0.5f,
				                 groundColorTint.g / 0.349f * 0.5f,
				                 groundColorTint.b / 0.341f * 0.5f);
			else
			...
			Vector3 c0 = new Vector3 (Mathf.Lerp (currentColor.r - offsetRange, currentColor.r + offsetRange, t.x),
